...
public class print_detail extends JFrame {
	...
	public print_detail(Book book) {
		...
		if(book.borrowed_id != null) { txt_borrowedID.setText(book.borrowed_id.substring(0, 3) + "****"); }
		else { txt_borrowedID.setText(""); }
		...
		label_nowtime.setText("인쇄 시간: " + nowtime_string);
	...
	//참고: https://annehouse.tistory.com/?page=234
	public void print() {               
	    PrintJob pjb = getToolkit().getPrintJob(this, "상세정보 인쇄", null);
